...
public class MainText_Fragment extends BaseFragment implements LocationSource, AMapLocationListener {

    private static MainText_Fragment mainTextfragment = null;
    ...
    public static Fragment newInstance(){
        if (mainTextfragment == null){
            synchronized (MainText_Fragment.class){
                if (mainTextfragment == null){
                    mainTextfragment = new MainText_Fragment();
                }
            }
        }
    ...
    void setCameraPosition(CameraPosition cameraPosition) {
        MainText_Fragment.cameraPosition = cameraPosition;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View mapLayout = inflater.inflate(R.layout.main_text_fragment, null);
    ...
    private LatLng pop(){
        ...
        double[][] testNum = {{26.452532, 106.524828}, {26.450548, 106.526748},
                {26.449218, 106.524757}, {26.451468, 106.523376},
                {26.456293, 106.523078}, {26.453532, 106.504814},
                {26.450147, 106.525238} };
        //模拟从服务器中获取到的商店信息
