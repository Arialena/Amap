...
public class Xia_OrdersFragment extends BaseFragment implements LocationSource, AMapLocationListener {

    private static Xia_OrdersFragment xiaFragment = null;
    ...
    public static Fragment newInstance(){
        if (xiaFragment == null){
            synchronized (Xia_OrdersFragment.class){
                if (xiaFragment == null){
                    xiaFragment = new Xia_OrdersFragment();
                }
            }
        }
        return xiaFragment;
    ...
    void setCameraPosition(CameraPosition cameraPosition) {
        Xia_OrdersFragment.cameraPosition = cameraPosition;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View mapLayout = inflater.inflate(R.layout.xia_orders, null);
